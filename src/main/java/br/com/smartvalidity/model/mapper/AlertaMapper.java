...
public final class AlertaMapper {
    ...
    public static AlertaDTO.Listagem toListagemDTO(Alerta alerta) {
        ...
        // Se alerta automático baseado em itemProduto
        ...
        // Coleção de usuários destinatários
