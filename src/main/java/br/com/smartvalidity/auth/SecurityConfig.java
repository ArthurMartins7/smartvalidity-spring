...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(
                        ...
                        auth -> auth
                                //URLs liberadas
                                .requestMatchers("/auth/*", "/public/*", "/public/webhook/**", "/public/openfoodfacts/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200", "http://31.97.251.133")); // Libera a origem do Angular e IP externo
        ...
        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200/*", "http://31.97.251.133/*"));
